    ...
    return (
        ...
        <form onSubmit={handelLogin} action="" className="space-y-6">
            <div className="space-y-2 text-sm">
                ...
                <input type="text" name="email" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " />
            </div>
            <div className="space-y-2 text-sm">
